...
import { setTvVideoId } from "../utils/redux/tvdetailslice";
import usefetchtvVideo from "../utils/Hooks/usefetchtvVideo";

const Tvvideoback = ({ movieId, movieImg }) => {
  const dispatch=useDispatch();
  

  const videos = useSelector((state) => state.tvdetails.TvvideoId) || [];

  const [videoplay, setVideoplay] = useState(null);

  usefetchtvVideo(movieId,setTvVideoId);
