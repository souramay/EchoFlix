...
export const backgroundImg = getRandomBgImg();
export const logoTab = "/img/logo/logo-tab2.png";
export const footerImg="/userProfile/Admin/Adobe Express - file.png"
export function getRandomBgImg() {
	const num = Math.floor(Math.random() * 3) + 1; // 1 to 3
	return `/img/Background/Background${num}.jpg`;
}



export const movieImageUrlforbackground = "https://image.tmdb.org/t/p/original";
...
export const firstpartVideoUrl='https://api.themoviedb.org/3/movie/';
...
export const tvfirstpartVideoUrl='https://api.themoviedb.org/3/tv/';
